    ...
    <div className='flex flex-col '>
      ...
      <div className='flex flex-col m-8 gap-4'>
        <div className='w-[100%] h-80 border-2 rounded-lg border-b-4 border-b-Dblue flex flex-col'>
          <div className='w-[100%] h-20 bg-Dblue overflow-hidden text-white p-2 rounded-t-lg max-md:h-auto'>
            <h1 className='text-xl'>Department of</h1>
            <h1 className='text-3xl font-semibold'>Computer Engineering</h1>
          </div>
          <div className='w-[65%] h-60 text-gray-700 p-4 gap-2 flex flex-col font-medium max-md:w-fit'>
